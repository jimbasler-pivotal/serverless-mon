...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun->serverless-mon]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=jimbasler-pivotal&repo=serverless-mon'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [dev.local->tapkadourahregistry....(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun template repo->serverless-mon]
